...
const { browserIsInitialized, sleep, fixSelector, interleaveArrayToObject } = require('./util')
 ...
 * options:
 *    @property {boolean} wait - Indicates if this method has to wait until the "pageLoaded" event is triggered
 * after calling the "Page.navigate" method
 */

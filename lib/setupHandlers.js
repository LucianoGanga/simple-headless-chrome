...
module.exports = async function setupHandlers () {
  ...
  Page.javascriptDialogOpening((...params) => {
    debug('-- javascriptDialogOpening', ...params)
  ...
  Page.javascriptDialogClosed((...params) => {
    debug('-- javascriptDialogClosed', ...params)

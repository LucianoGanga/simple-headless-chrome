      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 8;
            return this.client.browserLog.enable();

          case 8:
            this.client.Log.entryAdded(function (entry) {
              return _this.options.browserLog(entry.entry);
            });
            _context.next = 19;
            break;

          case 11:
            if (!(this.options.browserLog === true)) {
              _context.next = 18;
              break;
            }
          ...
          case 19:
            ...
            Network.requestWillBeSent(function () {
              ...
              debug.apply(undefined, [`-- Network.requestWillBeSent: `].concat(params));
              _this.emit.apply(_this, ['requestWillBeSent'].concat(params));
            });
            ...
            */
            this.client.Runtime.consoleAPICalled(function () {
              ...
              if (params[0].type === 'log') _this.emit('onConsoleMessage', params[0].args);
            });
